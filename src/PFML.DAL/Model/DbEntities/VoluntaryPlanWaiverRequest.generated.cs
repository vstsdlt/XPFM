...
namespace PFML.DAL.Model.DbEntities
{
    ...
    public class VoluntaryPlanWaiverRequest : BaseEntity
    {
        ...
        [Key]
        [Required]
        [Column("VoluntaryPlanWaiverRequestId", Order=1)]
        ...
        internal static void ModelCreating(DbModelBuilder builder)
        {
            ...
            builder.Entity<VoluntaryPlanWaiverRequest>().HasRequired(x => x.Form).WithMany(x => x.VoluntaryPlanWaiverRequests).HasForeignKey(x => x.FormId);
        }
